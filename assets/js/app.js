var topics = ["Leslie Knope", "Ron Swanson", "Andy Dwyer", "Ben Wyatt", "April Ludgate", "Tom Haverford",
"Jerry Gergitch", "Chris Trager", "Donna Meagle", "Jean Ralphio"];
var numberOfGIFs = 10;
var cutOffRating = "PG";
...
function renderButtons(){
	for(var i = 0; i < topics.length; i++) {
		...
		newButton.addClass("parks-button");
		newButton.text(topics[i]);
		$("#button-container").append(newButton);
	}
	$(".parks-button").unbind("click");
